...
// signing, inline enforcement) that the starter image physically lacks.
//
...
// "upgrade" state on enterprise installs; starter resolves to locked once the
...
export function useFeatures() {
  ...
  return {
    ...
    isStarter: loaded ? cfg!.edition === "starter" : false,
